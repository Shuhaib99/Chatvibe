...
function Navigation() {
    ...
    return (
        <div className='md:fixed md:w-2/12'>
            <Card noPadding={true}>
                <div className=' px-4 py-2 flex gap-4 md:block shadow-md shadow-gray-500 md:shadow-none '>

                    <h2 className='text-gray-400 font-bold mb-3 hidden md:block'>Navigation</h2>
                    <Link to="/" className={pathname === '/' ? active_element : nonActive_element}>
                    ...
                    {/* <Link to="/" className={pathname === '/followers' ? active_element : nonActive_element} >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    <Link to="/savedposts" className={pathname === '/savedposts' ? active_element : nonActive_element} >
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
