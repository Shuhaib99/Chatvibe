    ...
    return (
        <div>
            ...
            <div className='w-full fixed bottom-5 -ml-5 '>
                ...
                <div className='bg-blue-900 z-[999] ml-auto rounded-full h-14 w-14 text-yellow-400 flex justify-center items-center cursor-pointer' onClick={() => { isChat ? setChat(false) : setChat(true) }}>
                ...
                {isChat || chatActn &&<div className='z-50'>
                    <Chat />
                </div>}
            </div>
