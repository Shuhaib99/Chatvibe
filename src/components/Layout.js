...
function Layout({ children }) {
    ...
    return (
        <div>
            ...
            <div className=' w-full fixed bottom-20 md:bottom-5 -ml-5 '>
                <div className=' bg-black/90 ml-auto rounded-full h-14 w-14 text-green-400 flex justify-center items-center cursor-pointer hover:text-yellow-400' onClick={() => { isChats ? setChats(false) : setChats(true) }}>
                ...
                {isChats || chatActn !== "" && <div className=''>                    
                    <Chat />
                </div>
                }
            </div>
