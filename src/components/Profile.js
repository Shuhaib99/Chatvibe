...
function Profile() {
  ...
  const tab_classes = 'flex gap-2 px-5 items-center border-b-4 border-b-white'
  const active_tab_classes = 'flex gap-2 md:px-4 py-1 items-center border-socialBlue border-b-4 text-socialBlue font-bold'
